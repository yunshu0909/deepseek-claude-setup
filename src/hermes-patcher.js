 ...
 * - 将 Hermes 模型运行时切到 OpenAI Chat Completions + 本地 DeepSeek 代理
 ...
 * @returns {boolean} true 表示当前配置指向本地代理
 */
function isPatched() {
  const content = read();
